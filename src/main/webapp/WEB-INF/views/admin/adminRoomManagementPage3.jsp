			...
			<section id="u_select">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="<c:url value='./roomSelect1Status3' />">가나다순</a></li>
						<li><a href="<c:url value='./roomSelect2Status3' />">최신순</a></li>
						<li><a href="<c:url value='./roomSelect3Status3' />">오래된순</a></li>
					</ul>
				</div>
			</section>

			<div class="search">
				<form action="<c:url value='./roomSearch3' />" method="get">
