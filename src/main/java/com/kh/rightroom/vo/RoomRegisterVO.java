...
public class RoomRegisterVO {
	...
	private Boolean t_set1;
	private Boolean t_set2;
	private Boolean t_set3;
	private Boolean t_set4;
	...
	public Boolean getT_set1() {
		return t_set1;
	}

	public void setT_set1(Boolean t_set1) {
		this.t_set1 = t_set1;
	}

	public Boolean getT_set2() {
		return t_set2;
	}

	public void setT_set2(Boolean t_set2) {
		this.t_set2 = t_set2;
	}

	public Boolean getT_set3() {
		return t_set3;
	}

	public void setT_set3(Boolean t_set3) {
		this.t_set3 = t_set3;
	}

	public Boolean getT_set4() {
		return t_set4;
	}

	public void setT_set4(Boolean t_set4) {
		this.t_set4 = t_set4;
	}
